...
public class entrega_liston_oro_zonasur extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.flechaOro:
                ...
                Intent menu = new Intent(entrega_liston_oro_zonasur.this, menu_zona_sur.class);
                startActivity(menu);
                onStop();
                break;
