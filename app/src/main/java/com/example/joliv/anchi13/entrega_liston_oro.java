...
public class entrega_liston_oro extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.flechaOro:
                ...
                Intent menu = new Intent(entrega_liston_oro.this, menu_zona_norte.class);
                startActivity(menu);
                onStop();
                break;
